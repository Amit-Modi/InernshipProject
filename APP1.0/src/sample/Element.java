...
import static sample.EditPages.enableMovable;
import static sample.EditPages.setToFront;
...
public class Element {
    ...
    public static StackPane getTextBox(Rectangle rec){
        ...
        textArea.setStyle("-fx-background-color: transparent;-fx-font-family: \"System\";-fx-font-size: 18; -fx-text-fill: black;");
    ...
    public static StackPane getTitleBox(Rectangle rec){
        ...
        box.setStyle("-fx-background-color: transparent;-fx-font-family: \"System\";-fx-font-size: 32; -fx-text-fill: black;");
        box=enableEdit(box);
    ...
    public static StackPane getImageBox(Image image,Rectangle rec){
        ...
        if(rec.getWidth()==0.0 && rec.getHeight()==0.0){
            box.setFitWidth(image.getWidth());
            box.setFitHeight(image.getHeight());
        }
        else {
...
//        playpause.setText("play");
    ...
    public static StackPane getBrowser(String url,Rectangle rec){
        WebView browser=new WebView();
        WebEngine webEngine = browser.getEngine();
        try {
            webEngine.load(url);
            StackPane.setMargin(browser, margin);

            browser.setMaxWidth(rec.getWidth());
            browser.setMinWidth(rec.getWidth());
            browser.setMaxHeight(rec.getHeight());
            browser.setMinHeight(rec.getHeight());
